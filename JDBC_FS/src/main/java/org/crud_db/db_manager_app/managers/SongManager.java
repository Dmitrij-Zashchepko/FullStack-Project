...
public class SongManager {
    ...
    private static final String SONG_NOT_FOUND_MSG = "Песня не найдена.";
    ...
    private void getSongById() {
        ...
        try {
            ...
            if (song != null) {
                ...
                logger.log(Level.INFO, SONG_NOT_FOUND_MSG);
            }
        } catch (SQLException e) {
            logger.log(Level.SEVERE,"Ошибка поиска: " + e.getMessage());
        }
    }
