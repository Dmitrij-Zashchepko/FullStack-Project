...
public class UserManager {
    ...
    private final static String dateTimeFormat = "yyyy-MM-dd HH:mm";
        ...
        try {
            ...
            for (User user : users) {
                System.out.printf("%d. %s (%s) - зарегистрирован %s, последний вход: %s%n",
                        ...
                        user.getUsername(),
                        user.getEmail(),
                        user.getCreatedAt().format(DateTimeFormatter.ofPattern(dateTimeFormat)),
                        user.getLastLogin() != null ?
                                user.getLastLogin().format(DateTimeFormatter.ofPattern(dateTimeFormat)) :
                                "никогда");
            }
        } catch (SQLException e) {
    ...
    private void getUserById() {
        ...
        try {
            ...
            if (user != null) {
                System.out.printf("\nНайден пользователь: %s (%s)%nЗарегистрирован: %s%nПоследний вход: %s%n",
                        user.getUsername(),
                        user.getEmail(),
                        user.getCreatedAt().format(DateTimeFormatter.ofPattern(dateTimeFormat)),
                        user.getLastLogin() != null ?
    ...
    private void showUserPlaylists() {
        playlistManager.showUserPlaylists();
    }
