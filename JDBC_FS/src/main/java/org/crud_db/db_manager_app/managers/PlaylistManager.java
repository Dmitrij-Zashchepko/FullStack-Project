...
public class PlaylistManager {
    ...
    private static final String privatePlaylistMsg = "Приватный";
    private static final String publicPlaylistMsg = "Публичный";
    private static final String insertPlaylistIDMsg = "\nВведите ID плейлиста: ";
    private static final String excErrorMsg = "Ошибка: ";
    ...
    private void addPlaylist() {
        ...
        try {
            ...
            System.err.println(excErrorMsg + e.getMessage());
        }
    }

    private void deletePlaylist() {
        System.out.print(insertPlaylistIDMsg);
        int id = readIntInput();
        ...
        try {
            ...
            for (Playlist playlist : playlists) {
                System.out.printf("%d. [%s] %s (Пользователь: %d, %s)%n",
                        ...
                        playlist.isPublic() ? publicPlaylistMsg : privatePlaylistMsg,
                        playlist.getTitle(),
                        playlist.getUserId(),
    ...
    private void updatePlaylist() {
        ...
        try {
            ...
            System.out.print("\nИзменить статус? (текущее: " +
                    (playlist.isPublic() ? publicPlaylistMsg : privatePlaylistMsg) + ") (y/n): ");
