...
public class AlbumRepository {
    ...
    public Album getAlbumById(int albumId) throws SQLException {
        String sql = "SELECT album_id, title, artist_id, release_date, cover_image_url " +
    ...
    public List<Album> getAllAlbums() throws SQLException {
        String sql = "SELECT album_id, title, artist_id, release_date, cover_image_url FROM albums";
