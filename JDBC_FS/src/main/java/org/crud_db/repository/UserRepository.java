...
public class UserRepository {
    ...
    public List<User> getAllUsers() throws SQLException {
        ...
        String sql = "SELECT user_id, username, email, password_hash, created_at, last_login FROM users";
    ...
    public User getUserById(int userId) throws SQLException {
        String sql = "SELECT user_id, username, email, password_hash, created_at, last_login " +
