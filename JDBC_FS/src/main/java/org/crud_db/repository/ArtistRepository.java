...
public class ArtistRepository {
    ...
    public List<Artist> getAllArtists() throws SQLException {
        ...
        String sql = "SELECT artist_id, name, country, formed_date, biography FROM artists";
    ...
    public Artist getArtistById(int artistId) throws SQLException {
        ...
        String sql = "SELECT artist_id, name, country, formed_date, biography FROM artists WHERE artist_id = ?";
